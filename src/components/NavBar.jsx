    ...
    <nav className="fixed top-0 left-0 right-0 w-full flex justify-between items-center px-6 md:px-10 py-6 z-50">
      ...
      <div className="flex items-center space-x-8">
        ...
        <a 
          ...
          className=" text-black/45 hover:text-white transition-colors hover:scale-110 focus:outline-none"
        >
        ...
        <div className="relative flex flex-col items-center">
          ...
          {copiedState === 'email' && (
            <span className="absolute -bottom-8 px-2 py-1 text-xs text-white bg-gray-800 rounded shadow-lg animate-fade-in-up whitespace-nowrap">
              Email Copied!
            </span>
          )}
        </div>
